import { emojiFace } from '../constants/emoji';
...
//替换成emoji图片地址
export function emojiReplace(str) {
    if(!str) return '';
    var reg = new RegExp('\\[(.+?)\\]',"g");
    var nStr=str.replace(reg,function(match,capture){
         return '<img width="20" height="20" src="' + emojiFace['['+capture+']'] + '">'
    })
    return nStr;
}
